...
public abstract class BaseSection  implements Serializable {
	...
	// many to one
	private com.artm.hibernate.beans.Filieres codeFiliere;

	// collections
	private java.util.Set<com.artm.hibernate.beans.Matiere> matieres;
	private java.util.Set<com.artm.hibernate.beans.Ecolages> ecolages;
	private java.util.Set<com.artm.hibernate.beans.Inscriptions> inscriptions;
	private java.util.Set<com.artm.hibernate.beans.MatiereExam> matiereExams;
	private java.util.Set<com.artm.hibernate.beans.Parammatierexam> parammatierexams;
	 ...
	 */
	public com.artm.hibernate.beans.Filieres getCodeFiliere () {
		return codeFiliere;
	}
	 ...
	 */
	public void setCodeFiliere (com.artm.hibernate.beans.Filieres codeFiliere) {
	 ...
	 */
	public java.util.Set<com.artm.hibernate.beans.Matiere> getMatieres () {
		return matieres;
	}
	 ...
	 */
	public void setMatieres (java.util.Set<com.artm.hibernate.beans.Matiere> matieres) {
		this.matieres = matieres;
	}

	public void addToMatieres (com.artm.hibernate.beans.Matiere matiere) {
		if (null == getMatieres()) setMatieres(new java.util.TreeSet<com.artm.hibernate.beans.Matiere>());
	 ...
	 */
	public java.util.Set<com.artm.hibernate.beans.Ecolages> getEcolages () {
		return ecolages;
	}
	 ...
	 */
	public void setEcolages (java.util.Set<com.artm.hibernate.beans.Ecolages> ecolages) {
		this.ecolages = ecolages;
	}

	public void addToEcolages (com.artm.hibernate.beans.Ecolages ecolages) {
		if (null == getEcolages()) setEcolages(new java.util.TreeSet<com.artm.hibernate.beans.Ecolages>());
	 ...
	 */
	public java.util.Set<com.artm.hibernate.beans.MatiereExam> getMatiereExams () {
		return matiereExams;
	}
	 ...
	 */
	public void setMatiereExams (java.util.Set<com.artm.hibernate.beans.MatiereExam> matiereExams) {
		this.matiereExams = matiereExams;
	}

	public void addToMatiereExams (com.artm.hibernate.beans.MatiereExam matiereExam) {
		if (null == getMatiereExams()) setMatiereExams(new java.util.TreeSet<com.artm.hibernate.beans.MatiereExam>());
	 ...
	 */
	public java.util.Set<com.artm.hibernate.beans.Parammatierexam> getParammatierexams () {
	 ...
	 */
	public void setParammatierexams (java.util.Set<com.artm.hibernate.beans.Parammatierexam> parammatierexams) {
		this.parammatierexams = parammatierexams;
	}

	public void addToParammatierexams (com.artm.hibernate.beans.Parammatierexam parammatierexam) {
		if (null == getParammatierexams()) setParammatierexams(new java.util.TreeSet<com.artm.hibernate.beans.Parammatierexam>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.artm.hibernate.beans.Section)) return false;
		else {
			com.artm.hibernate.beans.Section section = (com.artm.hibernate.beans.Section) obj;
