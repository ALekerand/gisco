...
public abstract class BaseEcolages  implements Serializable {
	...
	// collections
	private java.util.Set<com.artm.hibernate.beans.Echeance> echeances;
	 ...
	 */
	public java.util.Set<com.artm.hibernate.beans.Echeance> getEcheances () {
		return echeances;
	}
	 ...
	 */
	public void setEcheances (java.util.Set<com.artm.hibernate.beans.Echeance> echeances) {
		this.echeances = echeances;
	}

	public void addToEcheances (com.artm.hibernate.beans.Echeance echeance) {
		if (null == getEcheances()) setEcheances(new java.util.TreeSet<com.artm.hibernate.beans.Echeance>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.artm.hibernate.beans.Ecolages)) return false;
		else {
			com.artm.hibernate.beans.Ecolages ecolages = (com.artm.hibernate.beans.Ecolages) obj;
