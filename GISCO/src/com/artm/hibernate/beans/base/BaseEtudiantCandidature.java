...
public abstract class BaseEtudiantCandidature  implements Serializable {
	 ...
	 */
	public BaseEtudiantCandidature (com.artm.hibernate.beans.EtudiantCandidaturePK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private com.artm.hibernate.beans.EtudiantCandidaturePK id;
     ...
     * @hibernate.id
     */
	public com.artm.hibernate.beans.EtudiantCandidaturePK getId () {
		return id;
	}
	 ...
	 * @param id the new ID
	 */
	public void setId (com.artm.hibernate.beans.EtudiantCandidaturePK id) {
		this.id = id;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.artm.hibernate.beans.EtudiantCandidature)) return false;
		else {
			com.artm.hibernate.beans.EtudiantCandidature etudiantCandidature = (com.artm.hibernate.beans.EtudiantCandidature) obj;
