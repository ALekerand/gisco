...
public abstract class BaseUtilisateurs  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.artm.hibernate.beans.Utilisateurs)) return false;
		else {
			com.artm.hibernate.beans.Utilisateurs utilisateurs = (com.artm.hibernate.beans.Utilisateurs) obj;
