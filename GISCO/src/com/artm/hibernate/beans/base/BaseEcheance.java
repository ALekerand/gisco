...
public abstract class BaseEcheance  implements Serializable {
	...
	// many to one
	private com.artm.hibernate.beans.Ecolages codeEcolage;
	 ...
	 */
	public com.artm.hibernate.beans.Ecolages getCodeEcolage () {
		return codeEcolage;
	}
	 ...
	 */
	public void setCodeEcolage (com.artm.hibernate.beans.Ecolages codeEcolage) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.artm.hibernate.beans.Echeance)) return false;
		else {
			com.artm.hibernate.beans.Echeance echeance = (com.artm.hibernate.beans.Echeance) obj;
