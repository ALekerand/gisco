...
public abstract class BaseInscriptions  implements Serializable {
	...
	// many to one
	private hibernate.beans.Regime codeRegime;
	 ...
	 */
	public hibernate.beans.Regime getCodeRegime () {
		return codeRegime;
	}
	 ...
	 */
	public void setCodeRegime (hibernate.beans.Regime codeRegime) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof hibernate.beans.Inscriptions)) return false;
		else {
			hibernate.beans.Inscriptions inscriptions = (hibernate.beans.Inscriptions) obj;
