...
public abstract class BaseFilieres  implements Serializable {
	...
	// many to one
	private hibernate.beans.Ecole codeEcole;

	// collections
	private java.util.Set<hibernate.beans.Section> sections;
	 ...
	 */
	public hibernate.beans.Ecole getCodeEcole () {
		return codeEcole;
	}
	 ...
	 */
	public void setCodeEcole (hibernate.beans.Ecole codeEcole) {
	 ...
	 */
	public java.util.Set<hibernate.beans.Section> getSections () {
		return sections;
	}
	 ...
	 */
	public void setSections (java.util.Set<hibernate.beans.Section> sections) {
		this.sections = sections;
	}

	public void addToSections (hibernate.beans.Section section) {
		if (null == getSections()) setSections(new java.util.TreeSet<hibernate.beans.Section>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof hibernate.beans.Filieres)) return false;
		else {
			hibernate.beans.Filieres filieres = (hibernate.beans.Filieres) obj;
