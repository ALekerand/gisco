...
public abstract class BaseEcole  implements Serializable {
	...
	// collections
	private java.util.Set<hibernate.beans.Filieres> filieres;
	 ...
	 */
	public java.util.Set<hibernate.beans.Filieres> getFilieres () {
		return filieres;
	}
	 ...
	 */
	public void setFilieres (java.util.Set<hibernate.beans.Filieres> filieres) {
		this.filieres = filieres;
	}

	public void addToFilieres (hibernate.beans.Filieres filieres) {
		if (null == getFilieres()) setFilieres(new java.util.TreeSet<hibernate.beans.Filieres>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof hibernate.beans.Ecole)) return false;
		else {
			hibernate.beans.Ecole ecole = (hibernate.beans.Ecole) obj;
