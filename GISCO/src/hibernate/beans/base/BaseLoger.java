...
public abstract class BaseLoger  implements Serializable {
	 ...
	 */
	public BaseLoger (hibernate.beans.LogerPK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private hibernate.beans.LogerPK id;
     ...
     * @hibernate.id
     */
	public hibernate.beans.LogerPK getId () {
		return id;
	}
	 ...
	 * @param id the new ID
	 */
	public void setId (hibernate.beans.LogerPK id) {
		this.id = id;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof hibernate.beans.Loger)) return false;
		else {
			hibernate.beans.Loger loger = (hibernate.beans.Loger) obj;
