...
public abstract class BaseNotexam  implements Serializable {
	...
	private hibernate.beans.MatiereExam codeMatiereExam;
	 ...
	 */
	public hibernate.beans.MatiereExam getCodeMatiereExam () {
	 ...
	 */
	public void setCodeMatiereExam (hibernate.beans.MatiereExam codeMatiereExam) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof hibernate.beans.Notexam)) return false;
		else {
			hibernate.beans.Notexam notexam = (hibernate.beans.Notexam) obj;
