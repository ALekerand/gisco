...
public abstract class BaseCandidatSalle  implements Serializable {
	 ...
	 */
	public BaseCandidatSalle (hibernate.beans.CandidatSallePK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private hibernate.beans.CandidatSallePK id;
     ...
     * @hibernate.id
     */
	public hibernate.beans.CandidatSallePK getId () {
		return id;
	}
	 ...
	 * @param id the new ID
	 */
	public void setId (hibernate.beans.CandidatSallePK id) {
		this.id = id;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof hibernate.beans.CandidatSalle)) return false;
		else {
			hibernate.beans.CandidatSalle candidatSalle = (hibernate.beans.CandidatSalle) obj;
