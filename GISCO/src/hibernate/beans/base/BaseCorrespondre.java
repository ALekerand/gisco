...
public abstract class BaseCorrespondre  implements Serializable {
	 ...
	 */
	public BaseCorrespondre (hibernate.beans.CorrespondrePK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private hibernate.beans.CorrespondrePK id;
     ...
     * @hibernate.id
     */
	public hibernate.beans.CorrespondrePK getId () {
		return id;
	}
	 ...
	 * @param id the new ID
	 */
	public void setId (hibernate.beans.CorrespondrePK id) {
		this.id = id;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof hibernate.beans.Correspondre)) return false;
		else {
			hibernate.beans.Correspondre correspondre = (hibernate.beans.Correspondre) obj;
