...
public abstract class BaseMatiere  implements Serializable {
	...
	private java.util.Set<hibernate.beans.Semestre> semestres;
	 ...
	 */
	public java.util.Set<hibernate.beans.Semestre> getSemestres () {
		return semestres;
	}
	 ...
	 */
	public void setSemestres (java.util.Set<hibernate.beans.Semestre> semestres) {
		this.semestres = semestres;
	}

	public void addToSemestres (hibernate.beans.Semestre semestre) {
		if (null == getSemestres()) setSemestres(new java.util.TreeSet<hibernate.beans.Semestre>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof hibernate.beans.Matiere)) return false;
		else {
			hibernate.beans.Matiere matiere = (hibernate.beans.Matiere) obj;
