...
public abstract class BaseDetailcampus  implements Serializable {
	...
	// many to one
	private hibernate.beans.Campus codeCampus;
	 ...
	 */
	public hibernate.beans.Campus getCodeCampus () {
		return codeCampus;
	}
	 ...
	 */
	public void setCodeCampus (hibernate.beans.Campus codeCampus) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof hibernate.beans.Detailcampus)) return false;
		else {
			hibernate.beans.Detailcampus detailcampus = (hibernate.beans.Detailcampus) obj;
