...
public abstract class BaseCampus  implements Serializable {
	...
	// collections
	private java.util.Set<hibernate.beans.Detailcampus> detailcampus;
	 ...
	 */
	public java.util.Set<hibernate.beans.Detailcampus> getDetailcampus () {
		return detailcampus;
	}
	 ...
	 */
	public void setDetailcampus (java.util.Set<hibernate.beans.Detailcampus> detailcampus) {
		this.detailcampus = detailcampus;
	}

	public void addToDetailcampus (hibernate.beans.Detailcampus detailcampus) {
		if (null == getDetailcampus()) setDetailcampus(new java.util.TreeSet<hibernate.beans.Detailcampus>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof hibernate.beans.Campus)) return false;
		else {
			hibernate.beans.Campus campus = (hibernate.beans.Campus) obj;
