...
public abstract class BaseTypematiereconcours  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof hibernate.beans.Typematiereconcours)) return false;
		else {
			hibernate.beans.Typematiereconcours typematiereconcours = (hibernate.beans.Typematiereconcours) obj;
