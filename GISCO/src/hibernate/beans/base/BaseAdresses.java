...
public abstract class BaseAdresses  implements Serializable {
	...
	// collections
	private java.util.Set<hibernate.beans.Tuteurs> tuteurs;
	 ...
	 */
	public java.util.Set<hibernate.beans.Tuteurs> getTuteurs () {
		return tuteurs;
	}
	 ...
	 */
	public void setTuteurs (java.util.Set<hibernate.beans.Tuteurs> tuteurs) {
		this.tuteurs = tuteurs;
	}

	public void addToTuteurs (hibernate.beans.Tuteurs tuteurs) {
		if (null == getTuteurs()) setTuteurs(new java.util.TreeSet<hibernate.beans.Tuteurs>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof hibernate.beans.Adresses)) return false;
		else {
			hibernate.beans.Adresses adresses = (hibernate.beans.Adresses) obj;
